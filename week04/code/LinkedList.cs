...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                // If the location of 'value' is at the end of the list,
                // then we can call RemoveTail to remove the value
                if (curr == _tail)
                {
                    RemoveTail();
                }
                // If the location of 'value' is at the start of the list,
                // then we can call RemoveHead to remove the value
                else if (curr == _head)
                {
                    RemoveHead();
                }
                // For any other location of 'value', need to connect the neighbors of the node to be removed
                else
                {
                    curr.Next!.Prev = curr.Prev; // Connect the prev of the node after current to the node before current
                    curr.Prev!.Next = curr.Next; // Connect the next of the node before current to the node after current
                }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                curr.Data = newValue; // Replace any oldValue's with newValue
            }
